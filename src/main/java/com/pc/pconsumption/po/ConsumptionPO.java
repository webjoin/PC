package com.pc.pconsumption.po;


import javax.xml.bind.annotation.XmlRootElement;

import com.pc.pconsumption.framework.Viewt;


@XmlRootElement
@Viewt
public class ConsumptionPO  extends IConsumptionPOValue implements java.io.Serializable{
...
//	在页面展根据此字段分组
	...
	public ConsumptionPO() {}
	public ConsumptionPO(long id) {
		this.id = id;
	}
	public long getId() {
		return id;
